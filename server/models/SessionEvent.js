...
const sessionEventSchema = new mongoose.Schema({
  ...
  page: { type: String, enum: ['intro', 'search', 'record', 'admin', 'admin-live', 'admin-analytics', 'admin-students', 'admin-achievements', 'survey', 'poll', 'vibe', 'standup', 'journey', 'leaderboard', 'achievements'], required: true },
