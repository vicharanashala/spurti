...
const studentSchema = new mongoose.Schema({
  ...
  // AI Daily Mission Planner streak tracking
  dailyMissionStreak: { type: Number, default: 0 },
  weeklyMissionStreak: { type: Number, default: 0 },
  monthlyMissionStreak: { type: Number, default: 0 },
  longestMissionStreak: { type: Number, default: 0 },
  lastCompletedAllMissionsDate: { type: String, default: '' },
  lastCompletedAllMissionsWeek: { type: String, default: '' },
  lastCompletedAllMissionsMonth: { type: String, default: '' },
