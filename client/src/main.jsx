...
function App() {
  ...
  if (view === 'student' && profile) {
    return (
      <>
        <StudentView profile={profile} onBack={config.allowStudentSearch ? () => setView('landing') : null} onRefreshProfile={refreshProfile} />
        <SurveyModal
...
function StudentView({ profile, onBack, onRefreshProfile }) {
