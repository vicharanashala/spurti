...
import './styles.css';
import './styles/minecraft-tokens.css';
import StudentBandCard from './components/engagement/StudentBandCard';
import AdminBandGrid from './components/engagement/AdminBandGrid';
import AdminJourneyTargets from './components/journey/AdminJourneyTargets';
...
function StudentView({ profile, onBack }) {
  ...
  return (
    <main className="page compact">
      ...
      <StudentBandCard email={student.email} />
      <JourneyTracker email={student.email} />
...
function AdminView({ admin, auth, onBack }) {
  ...
  return (
    <main className="page compact">
      ...
      <Tabs tab={tab} setTab={setTab} tabs={[['leaderboard','Leaderboard'], ['attendance','Attendance'], ['live','Live'], ['analytics','Analytics'], ['engagement','Engagement'], ['targets','Targets'], ['students','Students']]} />
      {tab === 'leaderboard' && (
        <section className="panel">
          <div className="panel-head">
            <h2>Leaderboard</h2>
      ...
      {tab === 'engagement' && <AdminBandGrid auth={adminAuth} />}
      {tab === 'targets' && <AdminJourneyTargets auth={adminAuth} />}
