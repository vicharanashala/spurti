...
function NoDataCard({ onClose, setShowSkillTree }) {
 return (
 ...
 <button className="skilltree-entry-btn" onClick={() => setShowSkillTree && setShowSkillTree(true)}>🌳 Skill Tree</button>
 </p>
...
export default function WrappedStory({ onClose }) {
 ...
 if (!story?.available) return <NoDataCard onClose={onClose} setShowSkillTree={setShowSkillTree} />;
 ...
 return (
 <div className="wrapped-overlay">
 <button className="skilltree-entry-btn skilltree-entry-btn-float" onClick={() => setShowSkillTree(true)}>🌳</button>
 <button
 className="wrapped-x"
 onClick={onClose}
 ...
 {showSkillTree && (
   <div className="wlb-overlay">
     ...
     <button className="wrapped-close-btn" onClick={() => setShowSkillTree(false)}>✕</button>
   </div>
 )}
